...
Parser::Parser(BaseContext& context): context(context) {
	...
	infix(LTS_TT_PLUS, true);
	infix(LTS_TT_MINUS, true);
	infix(LTS_TT_DIVIDE, true);
	infix(LTS_TT_STAR, true);
	infix(LTS_TT_MODULO, true);
	infix(LTS_TT_AMP, true);
	infix(LTS_TT_PIPE, true);
	infix(LTS_TT_RAISE, true);
	infix(LTS_TT_LOGIC_AND, true);
	infix(LTS_TT_LOGIC_OR, true);
	infix(LTS_TT_LOGIC_XOR, true);
	infix(LTS_TT_LESS_THAN, true);
	infix(LTS_TT_GREATER_THAN, true);
	infix(LTS_TT_COMPARE_LESS_EQUALS, true);
	infix(LTS_TT_COMPARE_GREATER_EQUALS, true);
	infix(LTS_TT_COMPARE_EQUALS, true);
	infix(LTS_TT_COMPARE_NOT_EQUALS, true);
	infix(LTS_TT_STREAM_INSERT, true);
	infix("atan", true);
	infix("cross", true);
	infix("fcross", true);
	infix("is", true);
